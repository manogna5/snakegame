...
#Game Backgrounds
bg1 = pygame.image.load("welcome.jpg")
bg2 = pygame.image.load("snake.jpg")
intro = pygame.image.load("snake.jpg")
outro = pygame.image.load("gameover.jpg")
...
#Game Title
pygame.display.set_caption("Snake By Manogna")
